...
def make_transitions(proj, target_bound_states, run_name,
   state_name, naming_str, observ_file, transitions, out_dir=None):
    ...
    if out_dir is None:
        out_dir = os.dirname(observ_file)
...
if __name__ == "__main__":
    ...
    make_transitions(proj, target_bound_states, run_name, state_name, naming_str, observ_file, transitions, out_dir="")