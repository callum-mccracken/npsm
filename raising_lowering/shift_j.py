"""
This script makes applying the raising / lowering operator a little easier,
...
- mfdp.egv_2J_2T for delta_J = -1, +1
  ...
  - we also get a file for delta J = 0, but ignore that one
- eigv_Jplus.out file
...
for sign in [1, -1]:
    ...
    for two_J in range(init_2J+sign*2, sign*max_2J, sign*2):
        ...
        print("generated new files with J =", str(two_J/2-1)+", ", two_J/2+1)
